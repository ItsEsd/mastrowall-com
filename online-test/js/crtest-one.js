...
function ctrlqstex(e) {
  ...
  if (cat === "Value updated successfully!") {
    ...
    document.getElementById("enrolledinfo").innerHTML =
      "<div style='padding:20px;min-height:300px;' align='center'><div style='max-width:1000px;text-align:left;'>" +
      "<hr><p style='font-size:16px;'>MASTROWALL Exam Portal <span style='float:right;font-size:12px;'>" +
      currentTime +
      "</span></p><hr>" +
      "<br><p style='font-size:16px;'>Enrollment ID: <span style='color:blue;'>" +
      enid +
      "</span></p>" +
      "<p style='font-size:16px;'>Name: " +
      namestu +
      "</p>" +
      "<p style='font-size:16px;'>Exam ID: " +
      examid +
      "</p>" +
      "<p style='font-size:16px;'>Registered Email ID: " +
      eid +
      "</p><br><hr>" +
...
function sendStmail() {
  ...
  var embody =
    elemed +
    "<br><span style='float:center;font-size:14px;'>N.B. Do not reply to this email</span>";
