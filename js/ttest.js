...
function ctrlq(e) {
  ...
  if (cat === "Value updated successfully!") {
    ...
    document.getElementById("enrolledinfo").innerHTML =
      ...
      "<hr><p><span style='float:left;'><img src='https://mastrowall.com/images/logoRecBWsvg.svg' style='width:25px;'></span><span style='margin-left:5px;font-size:16px;color:#666666;'><b>M A S T R O W A L L | <a target='_blank' href='https://mastrowall.com/online-test/' style='text-decoration:none;color:#0c29cd;'>Online Test</a></b></a></span><span style='float:right;font-size:12px;'>" +
      currentTime +
      "</span></p><hr>" +
...
function examresultpdf() {
  ...
  oPrntWin.document.open();
  oPrntWin.document.write(
    '<!doctype html><html><head><title>M A S T R O W A L L - Test Result</title><link rel="stylesheet" href="css/bootstrap.min.css"><link rel="stylesheet" href="/css/main.css"></head><body style="width:100%;padding:10px;background-color:white;" onload="print();"><div align="center"><div style="max-width:800px;padding:10px;border:1px solid #e2e2e2;">' +
      elem.innerHTML +
...
function downloadqset() {
  ...
  oPrntWin.document.write(
    "<!doctype html><html><head><title>" +
      ...
      elem3.innerHTML +
      '</div><hr style="max-width:1000px;"><h4><a target="_blank" href="https://mastrowall.com" style="text-decoration:none;color:#d6d6d6;"><b>M A S T R O W A L L</b></a></h4></div></center></body></html>'
  );
  oPrntWin.document.close();
}
