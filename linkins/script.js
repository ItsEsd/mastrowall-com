...
function show_wall_lec() {
  ...
  $.getJSON(url, function(json) {
    ...
    for (v; v <= resultperList; v++) {
      ...
      '<img class="youvubthumb" onerror="this.onerror=null;this.src= `https://mastrowall.com/images/thumbnail.png`;"  src="http://img.youtube.com/vi/'+vidid+'/0.jpg">'+
