$(document).ready(function () {
  ...
  $.getJSON(url2, function (json) {
    ...
    $.getJSON(url, function (json) {
      ...
      document
        .getElementById("searchmwall")
        .setAttribute("placeholder", "Start here.. ");
    });
  });
});

document
  .getElementById("searchnote_wall")
  .addEventListener("click", result_vids);
    ...
    for (v; v < maxReVid - 1; v++) {
      if (rawdata[v].LecTitle === search) {
        ...
        document.getElementById("search_results_vid").innerHTML =
          '<div class="iteamvid "> <div class="card " align="center"> <div class="card-title holds-iframe"><iframe width="100%" height="280px" src="//www.youtube.com/embed/' +
          vidid +
...
document
  .getElementById("searchnote_wall")
  .addEventListener("click", result_notes);
