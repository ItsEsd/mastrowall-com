...
$(document).ready(function () {
  ...
  function displayVideos(data) {
    ...
    data.items.forEach((item) => {
      videoData = `<div class="yrbrslt embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" src="//www.youtube.com/embed/${item.id.videoId}" frameborder="0" allowfullscreen></iframe></div> <p> <a target="_blank" href="https://www.youtube.com/watch?v=${item.id.videoId}"> ${item.snippet.title}</a> <a target="_blank" style="color:#e8e8e8;" href="https://www.youtube.com/channel/${item.snippet.channelId}">${item.snippet.channelTitle}</a></p><hr style="border-width:2px; border-color:#4d4d4d;">`;
...
$("#search_youtube").click(function () {
  const srcvl = document.getElementById("searchmwall").value;
  document.getElementById("search").value = srcvl;
  $("#youtb").toggle();
  $("#gcustom").hide();
});
$("#search_gcustom").click(function () {
  ...
  $("#youtb").hide();
  const srcvl = document.getElementById("searchmwall").value;
  document.getElementById("gsc-i-id1").value = srcvl;
});
