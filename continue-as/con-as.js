...
formwall.addEventListener("submit", (event) => {
  ...
  var script_url_edureg2 =
    "AKfycbx-7lgnn4V0THVv34EhZG9NeCzM6k_IDSc7-yBi6dYYJC5GLJwPTJDGRybCJk8YRDAmTg";
...
function ctrlq(e) {
  if (e.result != "Reading Error!") {
    ...
    document.getElementById("secondlgcheckedu").innerHTML =
      "User email already exist!<br>Please Sign In<br>";
    document.getElementById("register").disabled = false;
  }
}
...
formwallstu.addEventListener("submit", (event) => {
  ...
  var script_url_stureg2 =
    "AKfycbzzzh5rew8s9WVxUScE1UcreSLhwmANyci0l8lwcPAizLM_Q6CuzYcl2Coa5dloUla05g";
...
function ctrlqs(e) {
  if (e.result != "Reading Error!") {
    ...
    document.getElementById("secondlgcheckstu").innerHTML =
      "User email already exist!<br>Please Sign In<br>";
...
formwallco.addEventListener("submit", (event) => {
  ...
  var script_url_coreg2 =
    "AKfycbxEO5KzmVKVVLcW9-ecNM5TjeH_0auZ-km0N_GYkSxI7lud7uCsW10GiCWczpfv-a5FTA";
...
function ctrlqc(e) {
  if (e.result != "Reading Error!") {
    ...
    document.getElementById("secondlgcheckco").innerHTML =
      "User email already exist!<br>Please Sign In<br>";
...
$("#confirmpasswrd").on("keyup", function () {
  if ($("#passwrd").val() == $("#confirmpasswrd").val()) {
    ...
    $("#msgedreg").html("Not Matching").css("font-size", "12px");
    $("#register").prop("disabled", true);
  }
  document.getElementById("eduregid").value =
    "ED-" +
...
$("#confirmpasswrdst").on("keyup", function () {
  if ($("#passwrdst").val() == $("#confirmpasswrdst").val()) {
    ...
    $("#msgedregst").html("Not Matching").css("font-size", "12px");
    $("#registerstu").prop("disabled", true);
  }
  document.getElementById("stregid").value =
    "ST-" +
    Math.random().toString(26).substring(2, 6) +
    Math.random().toString(26).substring(2, 6);
  var d = new Date();
...
$("#confirmpasswrdco").on("keyup", function () {
  if ($("#passwrdco").val() == $("#confirmpasswrdco").val()) {
    ...
    $("#msgedregco").html("Not Matching").css("font-size", "12px");
    $("#registerco").prop("disabled", true);
  }
  document.getElementById("coregid").value =
    "CR-" +
    Math.random().toString(26).substring(2, 6) +
    Math.random().toString(26).substring(2, 6);
  var d = new Date();
...
function sendconfirmem(mailat, nam, sgn) {
  var mbody =
    ...
    `</strong>,</p>
            ...
            <div class="cta">
              <a class="ctabutton" href="` +
    sgn +
    `" target="_blank"><img src="https://cdn.jsdelivr.net/gh/ItsEsd/mastrowall-com@2473dd8bc7e75f2efd9371bdebd44fd801300d00/images/signemail.png"></a>
            </div>
            <div class="footer">
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      document.getElementById("mailconf").innerHTML =
        "Cofirmation sent to your email.";
      setTimeout(function () {
